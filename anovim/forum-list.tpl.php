...
<table id="forum-<?php print $forum_id; ?>">
   <thead>
    <tr>
      ...
      <th class="last-post"><?php print t('Last post'); ?></th>
    </tr>
  </thead>
  <tbody>
  <?php foreach ($forums as $child_id => $forum): ?>
    <tr id="forum-list-<?php print $child_id; ?>" <?php print $forum->is_container ? 'class="container"' : 'class="forum" title="Forum: '.$forum->name.'"'; ?>>
      <td <?php print $forum->is_container ? 'colspan="4" class="container"' : 'class="forum"'; ?>>
        <?php /* Enclose the contents of this cell with X divs, where X is the
               ...
               */ ?>
          <?php print str_repeat('<div class="indent" title="">', $forum->depth); ?>
